...
//import { test, expect } from '@playwright/test';
  ...
  async function get_runs_api(suit_id, user_email, tma_key, project_key) {
      const apiUrl = 'https://10plabs.com/api/tests/get_runs/'+suit_id; // take suit_id as input from user"
